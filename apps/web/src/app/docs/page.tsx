  ...
  return (
    <div className="mx-auto max-w-2xl px-6 py-16">
      ...
      <ol className="mt-8 list-decimal space-y-3 pl-5 text-sm text-[var(--text-muted)]">
        <li>Sign in with demo@solderlab.dev / demo</li>
        <li>Open org solderlab → project blinky</li>
        <li>Seed fixtures or upload a KiCad zip</li>
        <li>Compare revisions, open a Design Review, run SolderLab Review /summarize</li>
      </ol>
    </div>
  );
}
